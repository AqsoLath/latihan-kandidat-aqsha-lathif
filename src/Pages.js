...
export default function Articles() {
    ...
    return (
        ...
        <div className="container mx-auto text-center text-slate-900">
            <h1 className="text-5xl mt-4">Pages</h1>

            <div>
                {!loaded ? <i>loading...</i> :
                    <ul className="mt-4">
                        {/* Lakukan pengulangan untuk halaman Pages berupa children dari Pages di route.json */}
...
export function HalamanPages() {
    ...
    return (
        <div className="container mx-auto pt-8 px-2">
            <h1 className="text-3xl font-semibold text-slate-900 text-center">Halaman Pages</h1>

            {/* Kemudian tampilkan apa yang kita dapat dari parameter url */}
            <h2 className="text-xl">{paramsUrl.halamanTitle}</h2>
        </div>
    )
}